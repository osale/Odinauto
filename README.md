...
│   │   └── demo/      # Odin Bilhandel mock website
├── backend/           # C# / ASP.NET Core
│   ├── Controllers/   # API endpoints
│   ├── Services/      # RAG pipeline, document processing
│   ├── Models/        # Database models
│   └── Data/          # PostgreSQL + pgvector setup
...
```bash
git clone https://github.com/your-username/odin-auto.git
cd odin-auto
```
...
> Login to the admin panel, upload documents, and ask questions through the chat widget on the Odin Bilhandel AS mock website.
